...
Ammo().then((Ammo) => {
  ...
  function createGridPlane() {
    ...
    var grid = new THREE.GridHelper(175, 20, 0xffb766, 0xffb766);
    grid.material.opacity = 0;
    grid.material.transparent = true;
    grid.position.y = 0.005;
    scene.add(grid);

    //Create Threejs Plane - base color changes
  ...
  function loadRyanText() {
    ...
    text_loader.load("./src/jsm/Roboto_Regular.json", function (font) {
      ...
      var geometry = new THREE.TextGeometry("PRITESH BHOI", {
        font: font,
        size: 3,
        height: 0.5, 
        curveSegments: 12,
  ...
  function loadEngineerText() {
    ...
    text_loader.load("./src/jsm/Roboto_Regular.json", function (font) {
      ...
      xMid = -0.43 * (geometry.boundingBox.max.x - geometry.boundingBox.min.x);
  ...
  function start() {
    ...
    createBillboard(
      ...
      2.5,
      -70,
      billboardTextures.biztacsTexture,
      URL.biztacs,
      Math.PI * 0.22
    );
    ...
    createBillboard(
      ...
      2.5,
      -78,
      billboardTextures.digiFarmTexture,
      URL.githubBagholder,
      Math.PI * 0.17
    );
    ...
    createBillboardRotated(
      ...
      1.25,
      -75,
      billboardTextures.gujaratBudgetTexture,
      URL.gujaratBudget,
      Math.PI * 0.15
    );

    ryanFloydWords(11.2, 1, -20);
    createTextOnPlane(-70, 0.01, -48, inputText.biztacsText, 20, 40);
    ...
    createBox(
      ...
      1,
      boxTexture.mail,
      "mailto:priteshbhoi18@gmail.com",
      0x000000,
      true
    );
    ...
    floatingLabel(6.875, 4.5, -70, "Facebook");
    floatingLabel(15.125, 4.5, -70, "LinkedIn");
    floatingLabel(22.875, 4.5, -70, "Email");
    floatingLabel(31, 4.5, -70, "Instagram");
    floatingLabel(39, 4.5, -70,"bhylu");

    allSkillsSection(-50, 0.025, 20, 40, 40, boxTexture.allSkills);
    allSkillsSection(61, 0.025, 13, 30, 60, inputText.activities);
    allSkillsSection(12,  0.001, 54, 7, 3.5, boxTexture.skrillex);
    allSkillsSection(12, 0.1, 45, 15, 15, boxTexture.edmText);
    ...
    simpleText(-42, -2, -30, "EXPERIENCE", 3);
